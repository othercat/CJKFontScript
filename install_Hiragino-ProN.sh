...
"${PlistFileRegx}" EntireString ".AppleTraditionalChineseFont-Medium" "HiraKakuProN-W6" "${SysPlistsDir}/CTPresetFallbacks.plist"
"${PlistFileRegx}" EntireString ".AppleSimplifiedChineseFont-Medium" "HiraginoSansGB-W6" "${SysPlistsDir}/CTPresetFallbacks.plist"
"${PlistFileRegx}" EntireString ".AppleTraditionalChineseFont-Regular" "HiraKakuProN-W3" "${SysPlistsDir}/CTPresetFallbacks.plist"
"${PlistFileRegx}" EntireString ".AppleSimplifiedChineseFont-Regular" "HiraginoSansGB-W3" "${SysPlistsDir}/CTPresetFallbacks.plist"
"${PlistFileRegx}" EntireString ".AppleTraditionalChineseFont-Light" "HiraKakuProN-W3" "${SysPlistsDir}/CTPresetFallbacks.plist"
...
"${PlistFileRegx}" EntireString ".AppleTraditionalChineseFont" "HiraKakuProN-W3" "${SysPlistsDir}/DefaultFontFallbacks.plist"
"${PlistFileRegx}" EntireString ".AppleSimplifiedChineseFont" "HiraginoSansGB-W3" "${SysPlistsDir}/DefaultFontFallbacks.plist"
"${PlistFileRegx}" EntireString "STHeitiTC-Light" "HiraKakuProN-W3" "${SysPlistsDir}/DefaultFontFallbacks.plist"

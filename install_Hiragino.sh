...
if [ ! -f "${LibraryFontsPath}/ヒラギノ角ゴ Pro W3.otf" ]
then
	echo "[Hiragino Sans Pro W3.otf is MISSING, ABORT MISSION.]"
	exit
fi

if [ ! -f "${LibraryFontsPath}/ヒラギノ角ゴ Pro W6.otf" ]
then
...
chown root:wheel "${LibraryFontsPath}/ヒラギノ角ゴ Pro W3.otf"
chown root:wheel "${LibraryFontsPath}/ヒラギノ角ゴ Pro W6.otf"
chmod 644 "${LibraryFontsPath}/Hiragino Sans GB W3.otf"
chmod 644 "${LibraryFontsPath}/Hiragino Sans GB W6.otf"
chmod 644 "${LibraryFontsPath}/ヒラギノ角ゴ Pro W3.otf"
chmod 644 "${LibraryFontsPath}/ヒラギノ角ゴ Pro W6.otf"
